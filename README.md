...
3. При першому запуску — створити PIN або увімкнути біометрію.
4. За потреби — виключити додатки в **Налаштування → Ігнорувати додатки**.
